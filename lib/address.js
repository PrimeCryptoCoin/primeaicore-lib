...
/**
 * Internal function to transform a primeaicoin address buffer
 *
 * @param {Buffer} buffer - An instance of a hex encoded address Buffer
 ...
 *
 * The addresses will be sorted lexicographically, as that is the trend in primeaicoin.
...
/**
 * Internal function to transform a primeaicoin address string
 *
 * @param {string} data
 * @param {String|Network=} network - either a Network instance, 'livenet', or 'testnet'
 * @param {string=} type - The type: 'pubkeyhash' or 'scripthash'
 ...
 *
 * @param {string} str - An string of the primeaicoin address
 * @param {String|Network=} network - either a Network instance, 'livenet', or 'testnet'
 * @param {string=} type - The type of address: 'script' or 'pubkey'
 * @returns {Address} A new valid and frozen instance of an Address
 */
 ...
 *
 * @returns {Buffer} primeaicoin address buffer
 */
 ...
 *
 * @returns {string} primeaicoin address
 */
