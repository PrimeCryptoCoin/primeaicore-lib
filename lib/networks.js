 ...
 * numbers for each primeaicoin network. Currently only supporting "livenet"
...
addNetwork({
  ...
  port: 8767,
  dnsSeeds: [
    'seed-primeai.primeaicoin.org',
    'seed-primeai.bitactivate.com'
  ]
});
...
var TESTNET = {
  ...
  DNS_SEEDS: [
    'seed-testnet-primeai.primeaicoin.org',
    'seed-testnet-primeai.bitactivate.com'
  ]
};
