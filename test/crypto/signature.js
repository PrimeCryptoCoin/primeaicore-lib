...
var JSUtil = primeaicore.util.js;
var Interpreter = primeaicore.Script.Interpreter;

var sig_canonical = require('../data/primeaid/sig_canonical');
var sig_noncanonical = require('../data/primeaid/sig_noncanonical');
...
describe('Signature', function() {
  ...
  describe('@isTxDER', function() {
    ...
    describe('primeaid fixtures', function() {
