...
var HDPrivateKey = primeaicore.HDPrivateKey;
var HDPublicKey = primeaicore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = primeaicore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(primeaicore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(primeaicore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      primeaicore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = primeaicore.PublicKey.fromPoint;
      primeaicore.PublicKey.fromPoint = function() {
        primeaicore.PublicKey.fromPoint = unstubbed;
