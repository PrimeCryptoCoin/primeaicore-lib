...
var script_tests = require('../data/primeaid/script_tests');
var tx_valid = require('../data/primeaid/tx_valid');
var tx_invalid = require('../data/primeaid/tx_invalid');

//the script string format used in primeaid data tests
Script.fromprimeaidString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected, witness, amount) {
    amount = amount || 0;
    var scriptSig = Script.fromprimeaidString(vector[0]);
    var scriptPubkey = Script.fromprimeaidString(vector[1]);
  ...
  describe('primeaid script evaluation fixtures', function() {
  ...
  describe('primeaid transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //primeaid casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.fromprimeaidString(scriptPubKeyStr);
          });
